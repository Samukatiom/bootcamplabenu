...
import { IDeleteDTO, IEditUserDTO, IGetUsersDTO, IGetUsersInputDTO, IGetUsersOutputDTO, IloginDTO, ISignupDTO, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public getUsers = async (input: IGetUsersInputDTO) => {
        ...
        const users = usersDB.map(userDB => {
            ...
            const userResponse : IGetUsersDTO = {
                id: user.getId(),
                name: user.getName(),
                email: user.getEmail()
            }
    ...
    public deleteUser = async (input: IDeleteDTO) => {
        const token = input.token
        const id = input.id
